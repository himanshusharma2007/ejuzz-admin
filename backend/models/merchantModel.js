...
merchantSchema.pre("save", function (next) {
  if (this.isModified("bankInformation")) {
    ...
    this.bankInformation.accountName = encrypt(
      this.bankInformation.accountName
    );
    this.bankInformation.accountHolder = encrypt(
      this.bankInformation.accountHolder
    );
    ...
    this.bankInformation.accountNumber = encrypt(
